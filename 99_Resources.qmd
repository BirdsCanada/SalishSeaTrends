...
## Accessing Code on the Birds Canada GitHub {#9.9BirdsCan}

All R scripts and code resources associated with this project, as well as many other tools and tutorials, are available on the [Birds Canada GitHub](https://github.com/BirdsCanada) page.

This repository is regularly updated and serves as the central hub for sharing code related to Birds Canada’s monitoring and research programs.

To access the code:

Visit https://github.com/BirdsCanada

Browse the list of repositories for relevant projects, including data access tools, analysis scripts, and the NatureCounts R package.
...
For advanced users, you can clone repositories using Git with the command:

bash git clone https://github.com/BirdsCanada/SalishSeaTrends.git

...
The map type your select to generate will be dependent on your `model` type.

If running a iCAR analysis, a static spatial plots can be generated:
...
Map of species trends per survey site resulting from the SPDE analysis are best displayed as an interactive Shine App:

...
Y#Manually Specify the start and end year of the analysis. These years should match those selected for the data cleaning scripts. 
Y1 = 2008
Y2 = 2024
...
Map of species trends per survey site resulting from the SPDE analysis.

<iframe src="https://dmethier.shinyapps.io/SalishSeaTrends_Map/" width="100%" height="600">

</iframe>

Code for creating the Shiny App are available at https://github.com/DMEthier/SalishSeaTrends_Map.
